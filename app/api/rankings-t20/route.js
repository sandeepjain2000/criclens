/**
 * GET /api/rankings-t20?action=load          — return cached T20 rankings JSON
 * GET /api/rankings-t20?action=basic&minInnings=10  — JSON basic rankings
 * GET /api/rankings-t20?p=…&alpha=…&…        — SSE stream while computing
 *
...
const CACHE_PATH = path.join(process.cwd(), '..', 'data', 'rankings_cache_t20.json');
const MAX_RANK = 100;
