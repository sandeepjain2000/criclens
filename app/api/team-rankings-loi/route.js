/**
 * GET /api/team-rankings-loi?action=load      — return cached team rankings JSON
 * GET /api/team-rankings-loi?minInnings=20    — SSE stream while computing
 *
...
const CACHE_PATH = path.join(process.cwd(), '..', 'data', 'team_rankings_cache_loi.json');
